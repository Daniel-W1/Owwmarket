            ...
            <div class="px-6">
                <div class="flex flex-wrap justify-center">
                    <div class="w-full px-4 flex justify-center relative">
                        ...
                        <div className={"relative w-40 h-40 cursor-pointer border-2 border-gray-600 rounded-full "} onMouseEnter={()=>setimageHovered(true)} onMouseLeave={()=>setimageHovered(false)}>
