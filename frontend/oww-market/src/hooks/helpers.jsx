...
export { GetProfileForUser, GetBids, GetShopForUser, GetAllProfiles, GetProductsForShop, GetUserById, GetProductById, CreateNewShop , GetShopById, GetRandomProfiles, FollowUser, UnfollowUser, GetFeedForUser};